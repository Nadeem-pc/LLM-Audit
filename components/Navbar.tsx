  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`glass border border-white/5 rounded-2xl md:rounded-[2rem] px-6 md:px-10 py-3 md:py-4 transition-all duration-300 ${
          scrolled ? "mx-4" : "mx-0"
        }`}>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              <Link href="/login" className="hidden sm:block text-sm font-bold text-white hover:text-brand-primary transition-colors">
                Connect
              </Link>
              <Link href="/audit">
